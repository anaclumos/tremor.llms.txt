...
>(({ className, checked, ...props }, forwardedRef) => {
  return (
    <CheckboxPrimitives.Root
      ...
      className={cx(
        // base
        "relative inline-flex size-4 shrink-0 appearance-none items-center justify-center rounded ring-1 shadow-sm transition duration-100 outline-none ring-inset enabled:cursor-pointer",
        // text color
